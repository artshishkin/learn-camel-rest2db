...
class DBPostgresRouteTest extends CamelTestSupport {
    ...
    void dbInsertTest() {
        //given
        String countryToInsert = "{\"name\":\"Ukraine\",\"capital\":\"Kyiv\"}";

        //when
        ArrayList rowsList = template.requestBody("direct:dbInput", countryToInsert, ArrayList.class);
